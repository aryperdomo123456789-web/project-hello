  ...
  return (
    <div className="w-80 border-l bg-white h-full flex flex-col overflow-y-auto">
      ...
      <div className="p-6 flex flex-col items-center text-center border-b">
        ...
        <p className="text-sm text-slate-500 mb-4">{contact.phone}</p>
        
        <div className="flex gap-2 w-full">
          <Button variant="outline" size="sm" className="flex-1 text-xs">Editar</Button>
          <Button variant="outline" size="sm" className="flex-1 text-xs">Bloquear</Button>
        </div>
      </div>
      ...
      <div className="p-6 border-b">
        ...
        <div className="flex flex-wrap gap-2">
          {contact.tags.map(tag => (
            <Badge key={tag} variant="secondary" className="px-2 py-1 text-[10px] uppercase font-bold tracking-wider bg-blue-50 text-blue-700 hover:bg-blue-100 border-none">
              {tag}
            </Badge>
          ))}
      ...
      <div className="p-6 space-y-6">
        <div>
          <h4 className="text-xs font-bold text-slate-400 uppercase tracking-widest mb-4">Informações Gerais</h4>
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm font-medium text-slate-700">{contact.sector}</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm font-medium text-slate-700">{contact.stage}</p>
              </div>
            </div>
        ...
        <div>
          ...
          <div className="p-3 bg-yellow-50 border border-yellow-100 rounded-lg text-xs text-slate-700 leading-relaxed italic">
            "Cliente interessado no plano enterprise. Aguardando retorno da proposta comercial enviada via e-mail."
          </div>

          ...
          <div className="flex items-center gap-6">
            ...
            <div className="flex items-center gap-3 pl-4 border-l">
              ...
              <button
                ...
                className="inline-flex items-center gap-2 rounded-lg border border-slate-200 px-3 py-2 text-xs font-bold text-slate-600 transition hover:border-red-200 hover:bg-red-50 hover:text-red-700 disabled:opacity-50"
              >
                <LogOut className="h-4 w-4" />
                <span className="hidden lg:inline">{loggingOut ? "Saindo..." : "Sair"}</span>
              </button>
            </div>
          </div>
        </header>
